...
abstraktní a lze jej zachytit konstrukcí. Daná konstrukce poté při provedení zkonstruuje denotát
výrazu. Jako příklad lze uvést například výraz "francouzský král." V době psaní této práce Francie
krále nemá. Výraz nemá žádný denotát, neuvádí žádné konkrétní individuum. Přesto výrazu
"francouzský král" rozumíme, výraz má svůj význam, jen v současné době neuvádí žádnou osobu.
...
tedy nad objekty z báze a funkcemi, ale také nad jinými konstrukce. Konstrukce však může operovat
pouze nad konstrukcemi nižšího řádu, než je konstrukce samotná, viz \ref{type-order}. Každou
...
\footnote{
    ...
    možné, aby objekt konstruoval sám sebe, viz rozvětvená hierarchie typů \ref{type-order}.
}
...
kompozicionality vyplývá, že je-li libovolný konstituent konstrukce $X$ $v$-nevlastní a v dané
...
\begin{enumerate}[i)]
    ...
    \item Nic jiného než i)-v) není konstrukcí řádu $n$ nad bází \textit{B}.
\end{enumerate}
