...
Máme-li pouze jednu podmínku se dvěmi větvemi, \textit{if} a \textit{else}, je využití funkce
...
Vrátí typ svého argumentu. Funkce může být užitečná například v~typově polymorfních funkcích,
...
\lstinline{DefaultFunction} i jejího předka \lstinline{FunctionInterface} je přiložena v příloze.
Uživatel tak může nahlédnout do přílohy práce, aby zjistil, jak dané třídy fungují a jaké metody
musí implementovat sám.
